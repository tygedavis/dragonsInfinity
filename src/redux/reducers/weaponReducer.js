...
const initialState = { //Eventually these numbers will be loaded in from a database
    weapons: [
        { name: 'Kick-butt Sword', numberOfDice: 2, typeOfDice: diceMapper.d12, generalBonus: 'str', addProficiencyBonus: true },
        { name: 'Friggin Throwing Stars', numberOfDice: 1, typeOfDice: diceMapper.d20, generalBonus: 'int', addProficiencyBonus: false }
    ],
    rollStats: {
        attackHitsRoll: 0,
